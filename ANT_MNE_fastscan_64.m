function [ fastscan ] = ANT_MNE_fastscan_64(pcfn, markfn, fsfn, filepath, criteria, verbose)
%
% ANT MNE CODES - FASTSCAN_64
%
...
%
% This is a modified version for the Waveguard 64+EOG montage used in the 
% Soulflow project. Do not use this for the Duke-129 montage. Note that
% technically both montages are referred to as the equidistant Duke system,
% and the proprietary trademark from ANT is called Waveguard. Here we use
% Waveguard in short to refer to the 64-channel montage.
%
...
%     markers = table2array(markers);
    ...
    load(fullfile(ANTinterface_path, 'waveguard_65_template.mat'), 'chanlocs')
    ...
    % Define the mid point between 3Z and 4Z
    ...
    % of the RAs
    load(fullfile(ANTinterface_path, 'waveguard_65_template.mat'), 'fs_label_order')
    ...
    load(fullfile(ANTinterface_path, 'waveguard_65_template.mat'), 'chanlocs_reord')
    ...
    % Re-order into the Waveguard template electrode order that is also the
